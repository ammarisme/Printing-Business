 ...
 */
public class PurchaseOrderSend extends IMSFrame {
     ...
     */
    public PurchaseOrderSend(IMSFrame parent, boolean modal) {
        super();
    ...
    private void initComponents() {
        ...
        backgroundPanel.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, -1, -1));
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(price)
                            .add(quantity)
                            .add(productName, 0, 237, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        centerPanel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 69, 440, -1));
        ...
        centerPanel.add(vendorId, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 24, -1, -1));

        jLabel1.setForeground(Theme.FONT_COLOR);
        jLabel1.setText("Vendor Id");
        jLabel1.setName("jLabel1"); // NOI18N
        centerPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 29, -1, -1));

        jLabel2.setForeground(Theme.FONT_COLOR);
        jLabel2.setText("Order Date");
        jLabel2.setName("jLabel2"); // NOI18N
        centerPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(249, 34, -1, -1));
        ...
        backgroundPanel.add(centerPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 1080, 490));
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(backgroundPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1158, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(backgroundPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 621, Short.MAX_VALUE)
        );
    ...
    */
    private void sendPOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendPOActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderSend.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseOrderSend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PurchaseOrderSend dialog = new PurchaseOrderSend(new IMSFrame(), true);
